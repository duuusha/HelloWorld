...
Intellij IDEA provides an embedded terminal that allows you to work with console user interfaces available in your operation system. By default, this can be PowerShell or cmd.exe on Windows, Shell or Bash on Linux. You can also use Git Bash on the command line.
